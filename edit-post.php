      ...
      <div class="nk-nav-scroll">
        <ul class="metismenu" id="menu">
          ...
          <li>
            ...
            <ul aria-expanded="false">
              <li><a href="./view-medicine.html">Available Medicines</a></li>
              <li><a href="./post-medicine.html">Post Medicine</a></li>
              <li><a href="./orders-made.html">Orders</a></li>
                ...
                <div class="form-validation">
                  <form class="form-valide" action="#" method="post">
                    <div class="form-group row">
                      <label class="col-lg-4 col-form-label" for="val-username">medicine name <span class="text-danger">*</span>
                      </label>
                      <div class="col-lg-6">
                        <input type="text" class="form-control" name="medicine" value="Panadol Extra" required />
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-lg-4 col-form-label" for="val-email">Quantity <span class="text-danger">*</span>
                      </label>
                      <div class="col-lg-6">
                        <input type="number" class="form-control" name="quantity" required value="20" />
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-lg-4 col-form-label" for="val-password">Units <span class="text-danger">*</span>
                      </label>
                      <div class="col-lg-6">
                        <input type="text" class="form-control" name="unit" required value="box" />
                      </div>
                    </div>
                    <div class="form-group row">
                      ...
                      <div class="col-lg-6">
                        <input type="number" class="form-control" required name="price" value="1000" />
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      <div class="col-lg-8 ml-auto">
                        ...
                        <a href="./my-posts.html" type="submit" name="Update" class="btn btn-primary">Update</a>
                      </div>
                    </div>
                  </form>
                </div>
